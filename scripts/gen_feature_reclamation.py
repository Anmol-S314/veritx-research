...
CAPS = [
 ...
 dict(id="FRA-PERF-002", capability="Wave-E metric exposure (makespan, critical path, utilization, request latency, TTFT, decode-step latency, sensitivity)",
  ...
  classification="NEEDS_CANONICALIZATION", priority="P0",
  required_action="Decide which Wave-E metrics are product claims and give them registry rows with producers. This is the single largest Phase-3 risk: implementing Static Evaluate without this reclaims one aggregate number and silently drops critical path, utilization, request-latency distribution, TTFT, decode-step latency and sensitivity.",
