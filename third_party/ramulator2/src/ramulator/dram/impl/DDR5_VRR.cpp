...
class DDR5_VRR : public DRAMSpec {
 public:
  ...
  struct Timing {
    ...
    nWTRM, nRTW, nRRDS, nRRDL, nWTRS, nWTRL, nFAW, nRFC, nREFI, nRFCsb, nCS, tCK_ps, nRFM, nRFMsb, nREFSBRD, nVRR,
    COUNT
    };
  };

  using CommandImpls = std::tuple<
      Cmd::ACT<DDR5_VRR>, Cmd::PREpb<DDR5_VRR>, Cmd::PREab<DDR5_VRR>, Cmd::RD<DDR5_VRR>, Cmd::WR<DDR5_VRR>,
      Cmd::RDA<DDR5_VRR>, Cmd::WRA<DDR5_VRR>, Cmd::REFab<DDR5_VRR>, Cmd::PREsb<DDR5_VRR>, Cmd::REFsb<DDR5_VRR>,
      Cmd::RFMab<DDR5_VRR>, Cmd::RFMsb<DDR5_VRR>, Cmd::VRR<DDR5_VRR>
  >;
  ...
  DDR5_VRR(const ConfigNode& config) {
    ...
    set_names(commands, command_names, {"ACT", "PREpb", "PREab", "RD", "WR", "RDA", "WRA", "REFab", "PREsb", "REFsb", "RFMab", "RFMsb", "VRR"});
    ...
    set_names(timings, timing_names, {
        ...
        "nRFC", "nREFI", "nRFCsb", "nCS", "tCK_ps", "nRFM", "nRFMsb", "nREFSBRD", "nVRR"
    });
