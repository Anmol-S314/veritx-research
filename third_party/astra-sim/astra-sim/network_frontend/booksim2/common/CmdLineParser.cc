...
void CmdLineParser::define_options() noexcept {
    options.set_width(70).allow_unrecognised_options().add_options()(
        ...
        "booksim2-flit-bytes", "BookSim2 flit size in bytes",
        cxxopts::value<int>()->default_value("8"))(
        "booksim2-ns-per-cycle", "NS per BookSim2 cycle",
        cxxopts::value<double>()->default_value("1"))(
        "booksim2-extra", "Semicolon-separated booksim cfg param=value overrides",
