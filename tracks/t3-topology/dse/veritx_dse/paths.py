"""veritx_dse.paths — Single source of truth for all path resolution.
...
Usage:
    from veritx_dse.paths import REPO, BOOKSIM_BIN, DSE_DIR
"""
...
# So 4 levels up from this file = repo root
...
# This catches misconfiguration immediately, not at runtime
def _verify():
