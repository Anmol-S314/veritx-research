...
class ResolvedFabricBundle:
    ...
    def revalidate(self) -> None:
        ...
        self.resolved_fabric.validate_against(
    ...
    def root_hashes(self) -> dict[str, str]:
        return {
            "resolved_fabric_hash": self.resolved_fabric
            .resolved_fabric_hash(),
            "fabric_hash": self.fabric.fabric_hash(),
            ...
            "router_route_hash": self.router_route.artifact_hash,
            "resolved_route_hash": self.resolved_route
            .resolved_route_hash(),
            "vc_assignment_hash": self.vc_assignment.vc_assignment_hash(),
            "packet_format_hash": self.packet_format.packet_format_hash(),
            "router_behavior_hash": self.router_behavior
            .router_behavior_hash(),
            "address_decode_hash": self.address_decode.address_decode_hash(),
        }
