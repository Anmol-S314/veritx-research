...
class TestCtx:
    ...
    def test_log_functions_dont_crash(self, ctx):
        from veritx_dse.logging import log, ok, fail, verbose, debug, banner, output
        log(ctx, "test")
        ok(ctx, "test")
        fail(ctx, "test")
        verbose(ctx, "test")
    ...
    def test_json_mode(self, tmp_path, capsys):
        from veritx_dse.logging import Ctx, output
    ...
    def test_log_file_append(self, tmp_path):
        from veritx_dse.logging import Ctx, log
        log_path = tmp_path / "test.log"
        c = Ctx(log_file=str(log_path))
        log(c, "first")
        log(c, "second")
...
class TestTopology:
    ...
    def test_lookup_by_name(self):
        from veritx_dse.presets import lookup_topo
    ...
    def test_make_anynet_topo(self, tmp_path):
        from veritx_dse.presets import make_anynet_topo
    ...
    def test_count_anynet_edges(self, tmp_path):
        from veritx_dse.presets import count_anynet_edges
        anynet = tmp_path / "test.anynet"
    ...
    def test_dense_presets_exist(self):
        from veritx_dse.presets import DENSE_PRESETS
...
class TestTraceStats:
    def test_detect_basic(self, tmp_trace):
        from veritx_dse.booksim import detect_trace_stats
...
class TestTraceExtract:
    def test_extract_burst(self, tmp_trace, tmp_path):
        from veritx_dse.traces import extract_burst
    ...
    def test_extract_uniform(self, tmp_trace, tmp_path):
        from veritx_dse.traces import extract_uniform
...
class TestTraceSlice:
    def test_slice_single_class(self, tmp_multiclass_trace, tmp_path):
        from veritx_dse.traces import slice_trace
...
class TestParseOutput:
    def test_parse_latency(self):
        from veritx_dse.booksim import parse_output
