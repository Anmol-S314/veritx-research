...
class TestAreaModel:
    ...
    def test_router_area_7nm(self):
        from veritx_dse.reports import estimate_router_area
...
class TestPowerModel:
    ...
    def test_dynamic_power(self):
        from veritx_dse.reports import estimate_dynamic_power
    ...
    def test_leakage_power(self):
        from veritx_dse.reports import estimate_leakage_power
        power = estimate_leakage_power(n_routers=64, process_nm=7)
        assert power > 0

    def test_total_power(self):
        from veritx_dse.reports import estimate_total_power
    ...
    def test_energy_per_bit(self):
        from veritx_dse.reports import compute_energy_per_bit
...
class TestTimingModel:
    ...
    def test_max_frequency_mesh(self):
        from veritx_dse.reports import estimate_max_frequency
    ...
    def test_critical_path(self):
        from veritx_dse.reports import estimate_critical_path_ps
        cp = estimate_critical_path_ps("mesh", 7, 256)
        assert cp > 0
        assert cp < 2000  # picoseconds, reasonable for 7nm

    def test_pipeline_stages(self):
        from veritx_dse.reports import router_pipeline_stages
...
class TestWorkloadShape:
    ...
    def test_collective_operations(self):
        from veritx_dse.compile_model import Workload, ModelFamily, CollectiveOp, CollectiveKind
        wl = Workload(
...
class TestArtifactSigning:
    ...
    def test_sign_manifest(self):
        from veritx_dse.artifact import sign_manifest
    ...
    def test_verify_manifest(self):
        from veritx_dse.artifact import sign_manifest, verify_manifest
        manifest = {"design_id": "abc123", "guardrail_hash": "deadbeef"}
        sig = sign_manifest(manifest, secret_key="test-key")
...
class TestDesignManifest:
    ...
    def test_create_manifest(self):
        ...
        from veritx_dse.compile_model import CompileRequest, Workload, ModelFamily, NocConfig, DependencyGraph, Agent, AgentKind
        cr = CompileRequest(
...
class TestWorkloadPresets:
    ...
    def test_preset_exists(self):
        from veritx_dse.presets import WORKLOAD_PRESETS
    ...
    def test_preset_to_compile_request(self):
        from veritx_dse.presets import WORKLOAD_PRESETS, preset_to_compile_request
