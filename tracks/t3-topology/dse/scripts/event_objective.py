...
sys.path.insert(0, "/tmp/t3-test/tracks/t3-topology/scripts")
...
if __name__ == "__main__":
    # Self-check: score two topologies from Test 3 artifacts
    events = json.load(open("/tmp/test1_events.json"))
    # Tag DP gradient AR as prio 1 for demo
    t3 = json.load(open("/tmp/test3_N64.json"))
