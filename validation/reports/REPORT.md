...
| check | authority | independence | value | verdict |
|---|---|---|---|---|
| conservation | conservation | independent | packets=1, flits=2, auth_flits=2/2 | exact |
| hand_counts | hand_calculated | independent | {"flits": 2, "packets": 1} | exact |
| hand_route | hand_calculated | independent | hand=6, canonical=6.0, authority=7.0 (expected 7) | exact |
...
| check | authority | independence | value | verdict |
|---|---|---|---|---|
| conservation | conservation | independent | packets=1, flits=3, auth_flits=3/3 | exact |
| hand_counts | hand_calculated | independent | {"flits": 3, "packets": 1} | exact |
| hand_route | hand_calculated | independent | hand=6, canonical=6.0, authority=7.0 (expected 7) | exact |
