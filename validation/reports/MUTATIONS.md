...
| M4_config_tamper_in_run_dir | `BookSimExecutionError: different bytes` | CAUGHT | refused: /tmp/validation-work-nj4on9st/m4/config.cfg already holds different bytes; refusing to overwrite a prepared input |
...
| M6_evidence_byte_flip | `BackendEvidenceError: modified after execution` | CAUGHT | refused: evidence file /tmp/validation-work-nj4on9st/m-real/backend-evidence.json digest c0fb2bb644512ee268a310fe701d32b716ae6fbe |
