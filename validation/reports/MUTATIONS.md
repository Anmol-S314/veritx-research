...
| M4_config_tamper_in_run_dir | `BookSimExecutionError: different bytes` | CAUGHT | refused: /tmp/validation-work-5qti837t/m4/config.cfg already holds different bytes; refusing to overwrite a prepared input |
...
| M6_evidence_byte_flip | `BackendEvidenceError: modified after execution` | CAUGHT | refused: evidence file /tmp/validation-work-5qti837t/m-real/backend-evidence.json digest 8dbec942158bfc9931d1baa68c2db5d48750e984 |
