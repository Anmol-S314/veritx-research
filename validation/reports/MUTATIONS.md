...
| M4_config_tamper_in_run_dir | `BookSimExecutionError: different bytes` | CAUGHT | refused: /home/datavex/veritx-scratch/validation-work-87pdb5l1/m4/config.cfg already holds different bytes; refusing to overwrite |
...
| M6_evidence_byte_flip | `BackendEvidenceError: modified after execution` | CAUGHT | refused: evidence file /home/datavex/veritx-scratch/validation-work-87pdb5l1/m-real/backend-evidence.json digest b3cc532ab43a453a |
