...
| M4_config_tamper_in_run_dir | `BookSimExecutionError: different bytes` | CAUGHT | refused: /tmp/validation-work-rg1fc3qm/m4/config.cfg already holds different bytes; refusing to overwrite a prepared input |
...
| M6_evidence_byte_flip | `BackendEvidenceError: modified after execution` | CAUGHT | refused: evidence file /tmp/validation-work-rg1fc3qm/m-real/backend-evidence.json digest 0e4b1f8e03eb0601116370bc87fee2188de5e74a |
