...
| P0.8 | Projection closure: rendered keys == required keys; pins exact; missing required field fails | §5.8 | VERIFY |
| P0.9 | BookSim conservation: parse/enforce loaded/injected/delivered packets and flits-injected/accepted; no unexplained `None` | §5.9 | VERIFY |
